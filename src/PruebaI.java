...
//        
       ...
       //client1.getState().setJobInterArrival(new DDNegExp(simulator, 1/1000));        
     //  client2.getState().setJobInterArrival(new DDUniform(simulator, 1, 30));
     //  client3.getState().setJobInterArrival(new DDNormal(simulator, 100, 30));
        //**************************************************************************************
...
//        new RoundRobinResourceSelector(resources);
        ...
        // configuracion de la capacida de procesamiento y del numero de CPU
         // resource1.setCpuCOOapacity(1000000000);
